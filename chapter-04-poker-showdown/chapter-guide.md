# Chapter 04 Guide — Poker Showdown

## Game vision
Poker Showdown is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a video poker game in JavaScript with deal, hold, and draw phases, then score the final hand with ranks like flush, straight, and full house.
```
