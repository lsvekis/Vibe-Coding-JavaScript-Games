# Chapter 15 Guide — Hero Dice: Villain Crisis

## Game vision
Hero Dice: Villain Crisis is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a superhero strategy game where the player selects heroes for villain scenarios, resolves battles with dice, awards XP, unlocks heroes, and saves campaign progress.
```
