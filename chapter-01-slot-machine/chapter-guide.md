# Chapter 01 Guide — Slot Machine

## Game vision
Slot Machine is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a JavaScript slot machine with three reels, a betting system, a jackpot counter, and localStorage so player progress persists after refresh.
```
