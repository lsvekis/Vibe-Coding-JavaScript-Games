# Chapter 05 Guide — Circuit Null

## Game vision
Circuit Null is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Build a circuit puzzle game where each tile can rotate and the goal is to connect a source tile to a core tile through valid links.
```
