# Chapter 02 Guide — Blackjack Command

## Game vision
Blackjack Command is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a vanilla JavaScript blackjack game with a shuffled deck, dealer AI, hit and stand actions, chip betting, and score calculation including ace logic.
```
