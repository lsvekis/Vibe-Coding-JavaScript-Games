# Chapter 10 Guide — Relic Cartographer

## Game vision
Relic Cartographer is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a grid-based expedition game with hidden traps, relic tiles, energy pickups, and an extraction tile that ends the run.
```
