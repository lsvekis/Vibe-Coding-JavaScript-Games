# Chapter 14 Guide — Second Shadow Heist

## Game vision
Second Shadow Heist is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a stealth puzzle game where the player's previous route becomes a ghost patrol on the next loop, and the goal is to grab a key and open the vault.
```
