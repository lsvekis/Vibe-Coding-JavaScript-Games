# Chapter 03 Guide — Roulette Frontier

## Game vision
Roulette Frontier is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Build a JavaScript roulette game where the player can bet on red, black, odd, even, or a single number, then calculate payouts from the spin result.
```
