# Chapter 07 Guide — Inversion Run

## Game vision
Inversion Run is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Build a side-scrolling JavaScript runner where the player flips gravity with the space bar to avoid top and bottom obstacles.
```
