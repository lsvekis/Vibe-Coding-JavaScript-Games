# Chapter 08 Guide — Wreckline Salvage

## Game vision
Wreckline Salvage is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a salvage game on a grid where the player uses limited oxygen to recover scrap, find air tanks, and avoid defense drones.
```
