# Chapter 12 Guide — Deadzone Sector

## Game vision
Deadzone Sector is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Create a top-down JavaScript space shooter using canvas with player movement, bullets, enemy waves, score tracking, and lives.
```
