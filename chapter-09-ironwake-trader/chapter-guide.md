# Chapter 09 Guide — Ironwake Trader

## Game vision
Ironwake Trader is used in the book to teach these ideas through a real project instead of isolated syntax drills.
...
```text
Build a trading game in JavaScript where the player buys goods at one port, sells them at another, survives pirate attacks, and upgrades the ship over time.
```
